...
import type { GetApiPilotsAllData, GetApiPilotsAllResponse, GetApiHeatmapForPilotData, GetApiHeatmapForPilotResponse, GetApiCompetitionsCurrentData, GetApiCompetitionsCurrentResponse, GetApiDashboardData, GetApiDashboardResponse } from './types.gen';
...
export const getApiHeatmapForPilot = <ThrowOnError extends boolean = false>(options?: Options<GetApiHeatmapForPilotData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetApiHeatmapForPilotResponse, unknown, ThrowOnError>({
        ...options,
