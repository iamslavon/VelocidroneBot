...
import type { GetApiMigrationPilotsData, GetApiPilotsAllData, GetApiPilotsAllResponse, GetApiResultsForPilotData, GetApiResultsForPilotResponse, GetApiCompetitionsCurrentData, GetApiCompetitionsCurrentResponse, GetApiDashboardData, GetApiDashboardResponse } from './types.gen';

export const client = createClient(createConfig());

export const getApiMigrationPilots = <ThrowOnError extends boolean = false>(options?: Options<GetApiMigrationPilotsData, ThrowOnError>) => {
